...
async function loadPlanetsDataPeriods(){
...
const newEarthPeriods = await loadPlanetsDataPeriods();
const minPeriod = Math.min(...newEarthPeriods);
const maxPeriod = Math.max(...newEarthPeriods);
console.log(`${minPeriod} days was thes shortest orbital period found!`);
